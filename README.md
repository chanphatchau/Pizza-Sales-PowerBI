...
To visualise and analyse pizza sales performance by identifying peak ordering times, popular product categories, and ingredient preferences using dynamic dashboards in Power BI.
...
- 📦 **Order Behaviour** – Delivery vs. pickup preferences  
